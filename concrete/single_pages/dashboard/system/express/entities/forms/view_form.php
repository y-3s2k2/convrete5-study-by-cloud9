...
<div class="ccm-dashboard-header-buttons btn-group">
    ...
    <?php } else { ?>
        <button type="button" class="btn btn-danger disabled launch-tooltip" title="<?php echo t('This form is used as the default view or edit form for its entity. It may not be deleted until another form is selected.')?>"><?php echo t('Delete Form') ?></button>
    <?php } ?>
</div>
    ...
    ?>
        ...
        <div class="ccm-item-set panel panel-default" data-field-set="<?php echo $set->getID()?>">
            <div class="panel-heading">
                ...
                <div><?php echo $set->getTitle() ? h($set->getTitle()) : t('(No Title)')?></div>
