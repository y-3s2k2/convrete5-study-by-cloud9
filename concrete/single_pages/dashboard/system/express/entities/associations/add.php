        ...
        <div class="form-group">
            ...
            <select name="target_entity" class="form-control">
                <?php foreach($entities as $targetEntity) { ?>
                    <option value="<?php echo $targetEntity->getID()?>" data-plural="<?php echo $targetEntity->getPluralHandle()?>" data-singular="<?php echo $targetEntity->getHandle()?>"><?php echo $targetEntity->getEntityDisplayName()?></option>
                <?php } ?>
            </select>
        </div>
        <div class="form-group">
