                    ...
                    <div class="col-xs-12">
                        <div class="ccm-dialog-help-item">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="visible-sm-inline visible-md-inline visible-lg-inline"><a href="#" data-launch-guide="toolbar"><?php echo t('Run Guide')?></a></li>
                            </ol>
                        </div>
                        <div class="ccm-dialog-help-item">
                            <h4><?php echo t('Add & Change Content')?></h4>
                            <ol class="breadcrumb">
                                <li><a href="https://www.youtube.com/watch?v=Y1VmBVffLM0" data-lightbox="iframe"><?php echo t('Watch Video')?></a></li>
                                <li class="visible-sm-inline visible-md-inline visible-lg-inline"><a href="#" data-launch-guide="change-content"><?php echo t(' Change Content')?></a></li>
                                <li class="visible-sm-inline visible-md-inline visible-lg-inline"><a href="#" data-launch-guide="add-content"><?php echo t('Guide: Add Content')?></a></li>
                            </ol>
                        </div>
                        <div class="ccm-dialog-help-item">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="visible-sm-inline visible-md-inline visible-lg-inline"><a href="#" data-launch-guide="add-page"><?php echo t('Run Guide')?></a></li>
                            </ol>
                        </div>
                        <div class="ccm-dialog-help-item">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="visible-sm-inline visible-md-inline visible-lg-inline"><a href="#" data-launch-guide="personalize"><?php echo t('Run Guide')?></a></li>
                            </ol>
                        </div>
                        <div class="ccm-dialog-help-item">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="visible-sm-inline visible-md-inline visible-lg-inline"><a href="#" data-launch-guide="dashboard"><?php echo t('Run Guide')?></a></li>
                            </ol>
                        </div>
                    </div>
                    </div>
