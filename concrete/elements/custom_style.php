        ...
        <li class="ccm-inline-toolbar-icon-cell"><a href="#" data-toggle="dropdown" title="<?php echo t('Custom CSS Classes, Block Name, Custom Templates and Reset Styles')?>"><i class="fa fa-cog"></i></a>
            ...
            <div class="ccm-inline-design-dropdown-menu dropdown-menu">
                ...
                <?php if ($style instanceof \Concrete\Core\Block\CustomStyle && $canEditCustomTemplate) { ?>
                    <div class="ccm-inline-select-container">
                        ...
                        <select id="bFilename" name="bFilename" class="form-control">
                            ...
                            <option value="<?php echo $tpl->getTemplateFileFilename()?>" <?php if ($bFilename == $tpl->getTemplateFileFilename()) { ?> selected <?php } ?>><?php echo $tpl->getTemplateFileDisplayName()?></option>
                            <?php } ?>
                        </select>
                     </div>
                    <hr/>
                ...
                <div>
                    ...
                    <?php echo $form->selectMultiple('customClass', $customClassesSelect, $customClassesSelected);?>
                </div>
                <hr/>

                <div>
                    <?php echo t('Custom ID'); ?>
                    <?php echo $form->text('customID', $customID, array('style' => 'height: 38px; font-size: 16px; margin-bottom: 0;')); ?>
                </div>
                <hr/>

                <div>
                    <?php echo t('Custom Element Attribute'); ?>
                    <?php echo $form->textarea('customElementAttribute', $customElementAttribute, array('style' => 'height: 38px; font-size: 16px; margin: 5px 0 0 0;')); ?>
                </div>
                <hr>
