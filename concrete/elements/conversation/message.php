...
if ((!$message->isConversationMessageDeleted() && $message->isConversationMessageApproved()) || $message->conversationMessageHasActiveChildren()) {
	...
	<div data-conversation-message-id="<?php echo $message->getConversationMessageID()?>" data-conversation-message-level="<?php echo $message->getConversationMessageLevel()?>" class="<?php echo $class?>">
		...
		<div class="ccm-conversation-message-user">
			<div class="ccm-conversation-avatar"><?php echo $formatter->getAvatar();
    ?></div>
    ...
    ?></span>
				...
				<span class="ccm-conversation-message-date"><?php echo $message->getConversationMessageDateTimeOutput($dateFormat);
    ?></span>
    ...
    ?>
                    <li><span class="ccm-conversation-message-rating-score" data-message-rating="<?php echo $message->getConversationMessageID()?>"><?php echo $message->getConversationMessageTotalRatingScore();
    ?></span></li>
              <?php
}
    ?>
