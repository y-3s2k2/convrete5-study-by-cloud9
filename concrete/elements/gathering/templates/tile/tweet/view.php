...
<div class="ccm-gathering-twitter">
	...
	<div class="tweet">
		...
		<p class="tweet-info"><span class="elapsed"><?php echo Core::make('date')->formatDate($date_time)?></span><span class="who-from"><a href="https://twitter.com/<?php echo $author ?>"><?php echo $author ?></a></span></p>
	</div>
</div>
