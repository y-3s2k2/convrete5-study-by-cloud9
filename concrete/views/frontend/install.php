...
if (isset($successMessage)) {
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#canonicalUrlAlternativeChecked').prop('checked', <?php echo $canonicalUrlAlternativeChecked ? 'true' : 'false'?>);
            <?php
            }
            ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="control-label">
                                        ...
                                        <?php echo t('Set main canonical URL')?>:
                                    </label>
                                    <?php echo $form->url('canonicalUrl', h($canonicalUrl), ['pattern' => 'https?:.+', 'placeholder' => t('%s or %s', 'http://...', 'https://...')])?>
                                </div>

                                <div class="form-group">
                                    <label class="control-label">
                                        <?php echo $form->checkbox('canonicalUrlAlternativeChecked', '1')?>
                                        <?php echo t('Set alternative canonical URL')?>:
                                    </label>
                                    <?php echo $form->url('canonicalUrlAlternative', h($canonicalUrlAlternative), ['pattern' => 'https?:.+', 'placeholder' => t('%s or %s', 'http://...', 'https://...')])?>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo $form->select('siteLocaleCountry', $countries, $computedSiteLocaleCountry) ?>
                                </div>

                                <div class="form-group">
                                    <label class="control-label" for="SERVER_TIMEZONE"><?php echo t('System Time Zone')?></label>
                                    <?php echo $form->select('SERVER_TIMEZONE', $availableTimezones, $SERVER_TIMEZONE, ['required' => 'required']) ?>
                                </div>

                                <script>
                                $('#siteLocaleLanguage').on('change', function() {
                                    $.ajax(
                                        <?php echo json_encode((string) $view->url('/install', 'get_site_locale_countries')) ?> + '/' + encodeURIComponent(<?php echo json_encode(Localization::activeLocale()) ?>) + '/' + encodeURIComponent(this.value) + '/' + encodeURIComponent($('#siteLocaleCountry').val()),
                                        {
                                            dataType: 'json'
                                        }
                                    )
                ...
                <div class="col-sm-6">
                    ...
                    <table class="table requirements-table">
                        ...
                        <tr>
                            ...
                            <td style="width: 100%">
                                <?php echo t('Tokenizer Extension Enabled') ?>
                            </td>
                            <td>
                                <?php
                                if (!$tokenizerTest) {
                                    ?>
                                    <i class="fa fa-question-circle launch-tooltip"
                                       title="<?php echo t('The PHP Tokenizer extension has been disabled intentionally on this server and must be enabled.') ?>"></i>
                                    <?php
                                }
                                ?>
                            </td>
    ...
    <div id="ccm-install-intro">
        ...
        <div class="form-group">
            <div class="input-group-lg input-group">
                ...
                ?>
                <?php echo $form->select('wantedLocale', $selectOptions, Localization::BASE_LOCALE); ?>
